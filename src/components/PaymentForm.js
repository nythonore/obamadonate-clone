...
const PaymentForm = () => {
  return (
    <div className='payment_form__payment p-4'>
      <div className='form'>
        <Form>
          <Row>
            <Col md={12}>
              ...
              <div className='d-flex justify-content-between'>
                ...
                <p>Already a supporter? <Link>Log in</Link></p>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            <Col md={12}>
              <Form.Control type='text' placeholder='Apartement, suite, etc, (optional)' />
            </Col>
          </Row>
          ...
          <Row>
            <Col md={6}></Col>
            <Col md={6}>
              <Button className='btn-block w-100'>Continue to payment</Button>
            </Col>
          </Row>
        </Form>
      </div>
      ...
      <div className='bottom'>
        <p>© 2021 Obama Foundation. All Rights Reserved.</p>
        <p>
          The Obama Foundation is a 501(c)(3) charitable organization that welcomes donations to <br />
          support its operations and programs. The Foundation will publicly disclose donations <br />
          quarterly by posting to the Foundation website. For required state fundraising <br />
          disclosures, <Link to='#'>click here.</Link> Transactions are <Link to='#'>secured by Shopify</Link>.
        </p>

        <p className='d-flex justify-content-between'>
          <Link to='#'>Terms & Conditions</Link>
          <Link to='#'>Privacy Policy</Link>
          <Link to='#'>Donation FAQ</Link>
        </p>
      </div>
    </div>
  );
